...
const fields: SimpleFieldSettings<ListEntityAutocompleteOptions> = [
...
export default TypeSettingsBase<ListType, ListEntityAutocompleteOptions>().extend({
  name: 'ListEntityAutocompleteSettings',
  computed: {
    optionFields: () => fields,
  },
});
