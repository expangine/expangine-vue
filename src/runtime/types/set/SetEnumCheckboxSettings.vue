...
const fields: SimpleFieldSettings<SetEnumCheckboxOptions> = [
  ...
  { name: 'onIcon', type: 'icon', label: 'On Icon', details: 'default: Checkbox Marked' },
...
export default TypeSettingsBase<EnumType, SetEnumCheckboxOptions>().extend({
  name: 'SetEnumCheckboxSettings',
  computed: {
    optionFields: () => fields,
  },
});
