...
const fields: SimpleFieldSettings<SetEnumAutocompleteOptions> = [
...
export default TypeSettingsBase<SetType, SetEnumAutocompleteOptions>().extend({
  name: 'SetEnumAutocompleteSettings',
  computed: {
    optionFields: () => fields,
  },
});
