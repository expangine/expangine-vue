...
const fields: SimpleFieldSettings<EntityAutocompleteOptions> = [
...
export default TypeSettingsBase<EntityType, EntityAutocompleteOptions>().extend({
  name: 'EntityAutocompleteSettings',
  computed: {
    optionFields: () => fields,
  },
});
